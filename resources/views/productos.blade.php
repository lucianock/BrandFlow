                                ...
                                <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-600 group">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <a href="{{ url('/producto/delete/'.$producto->idProducto) }}" 
                            ...
                            <div x-show="currentProduct" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex space-x-3 pt-4">
                                        ...
                                        <a :href="'/producto/delete/' + (currentProduct?.id || 0)" 
                                           class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
